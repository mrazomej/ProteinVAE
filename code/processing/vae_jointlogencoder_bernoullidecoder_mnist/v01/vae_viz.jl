...
train_results = JLD2.load("./output/vae_epoch0100.jld2")
...
# Plot loss
lines!(axloss, 1:100, train_results["train_loss"], label="train set")
lines!(axloss, 1:100, train_results["val_loss"], label="validation set")
...
# Plot cross-entropy
lines!(axentropy, 1:100, train_results["train_entropy"], label="train set")
lines!(axentropy, 1:100, train_results["val_entropy"], label="validation set")
...
# Plot loss
lines!(axmse, 1:100, train_results["train_mse"], label="train set")
lines!(axmse, 1:100, train_results["val_mse"], label="validation set")
